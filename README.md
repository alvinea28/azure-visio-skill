...
Code, guides, tests, and downloads are grouped by version. Platform comparison screenshots are in [sample ooutput](sample%20ooutput/).
...
![Fabric IQ Pilot architecture generated by Copilot Cowork](sample%20ooutput/fabric-iq-pilot-cowork.png)

### Microsoft Scout

![Fabric IQ Pilot architecture generated by Microsoft Scout](sample%20ooutput/fabric-iq-pilot-scout.jpeg)
...
Earlier AVS example: [Sample PDF](versions/v1.6/examples/AVS-Enterprise-Backup.pdf) | [Editable Visio](versions/v1.6/examples/AVS-Enterprise-Backup.vsdx).
